...
def read_wav(fname, return_rate=False):
    '''
         ...
         output:
                ...
                sr: sample rate
    '''
    src, sr = torchaudio.load(fname, channels_first=True)  # src.shape = [1,48000] sr=16000
    if return_rate:
...
class AudioReader(object):
    ...
    def __init__(self, scp_path, sample_rate=8000, chunk_size=24000, least_size=12000):
